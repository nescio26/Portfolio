...
export const workData = [
    {
        ...
        bgImage: '/work-6.png',
        link: 'https://github.com/nescio26/Wanna-Booking-System.git',
    },
    {
...
export const infoList = [
    { icon: assets.code_icon, iconDark: assets.code_icon_dark, title: 'Languages', description: 'HTML, CSS, JavaScript , C++, Java, SQL, PHP' },
    { icon: assets.edu_icon, iconDark: assets.edu_icon_dark, title: 'Education', description: 'Bachelor in Information Technology (hons.)' },
{
...
• SmartTutor – Web App (LMS)
• Wanna Booking – Web App
